...
struct MenuRoundedButton: View {
    ...
    let size: CGFloat
    init(foregroundColor: Color = Color(#colorLiteral(red: 0.5803921569, green: 0.1647058824, blue: 1, alpha: 1)), backgroundColor: Color = Color(#colorLiteral(red: 0.137254902, green: 0.03921568627, blue: 0.2352941176, alpha: 1)), iconName: String = "", textString: String = "", size: CGFloat = 100) {
    ...
    var body: some View {
        ZStack {
            ...
            if !self.iconName.isEmpty {
                Image(self.iconName, bundle: nil)
                    .resizable()
                ...
                PixelText(text: self.textString, fontSize: size*0.4, color: .white)
            }
